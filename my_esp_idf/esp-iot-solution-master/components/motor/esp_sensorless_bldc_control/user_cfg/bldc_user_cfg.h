 ...
 *
 */
#define FREQ_HZ (10*1000) /*<! Frequency in Hertz */
 ...
 */
#define RAMP_TIM_STA (600)               /*!< The start step time for climbing. A smaller value results in faster startup but may lead to overcurrent issues. */
#define RAMP_TIM_END (90)                /*!< The end step time for climbing, adjusted based on the load. If loaded, this value should be relatively larger. */
#define RAMP_TIM_STEP (7)                /*!< Decremental increment for climbing step time—adjusted in accordance with RAMP_TIM_STA. */
 ...
 *
 */
#define ZERO_CROSS_ADVANCE (8)               /*!< Advance switching at zero-crossing, switching angle = 180°/ZERO_CROSS_ADVANCE. angle compensation should be provided. >= 6 */
 ...
 *
 */
#define SPEED_KP (0.004)                         /*!< P */
#define SPEED_KI (0.00015)                       /*!< I */
#define SPEED_KD (0)                             /*!< D */
...
#define SPEED_MIN_OUTPUT (PWM_DUTYCYCLE_10)      /*!< Minimum PWM duty cycle output. */
